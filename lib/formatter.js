        ...
        if (systemTexts) {
            ...
            for (var stj = 0; stj < systemTexts.length; stj++) {
                ...
                if (stTick > prevStartTick && stTick <= line.startTick) {
                    ...
                    // For sequence labels (e.g. "Estrofa 1::2::3::"), re-emitting within
                    ...
                    // under the same label (e.g. ESTROFA 2). For # labels, always advance.
                    ...
                    if (isBackwards && emittedSysTexts[stKey] && isSeqLabel) {
                        if (inJumpReplay && lastRenderedLabel[rawText]) {
                            ...
                            // of the replay share the same label, e.g. ESTROFA 2).
                    ...
                    // (e.g. MÚSICA with interlude chords between ESTROFA and ESTRIBILLO).
