...
// fretDiagrams: optional array of fretboard diagrams to pass through
function formatLines(lines, chords, lastOutputChord, chordToTick, systemTexts, fretDiagrams) {
    var output = "";
    ...
    return { output: output, lastChord: lastOutputChord, fretDiagrams: fretDiagrams || [] };
}
...
// fretDiagrams: optional array of fretboard diagrams to pass through
function formatPerfLines(lines, introChords, homeChord, title, chords, syllables, systemTexts, fullRepeat, fretDiagrams) {
    ...
    output = output.replace(/\n{3,}/g, "\n\n");
    return { text: output, fretDiagrams: fretDiagrams || [] };
}
