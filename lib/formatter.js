...
function formatLines(lines, chords, lastOutputChord, chordToTick) {
    ...
    for (var l = 0; l < lines.length; l++) {
        ...
        // Fewer than 4 trailing chords: append to chord line
        // 4 or more: render as separate melodic/interlude line
        ...
        // 4+ trailing chords: separate melodic line after text
        if (trailingChords.length >= 4) {
            output += "\n" + wrapChordLine(trailingChords.join("  "), 70) + "\n";
        }
    }
