...
function processExtraction(data, mods) {
    ...
    var fretDiagrams = data.fretDiagrams || [];
    ...
    if (hasVoltas) {
        ...
        var result = mods.Formatter.formatPerfLines(streamLines, introChords, homeChord, title, chords, syllables, data.systemTexts, data.fullRepeat, fretDiagrams);
    ...
    if (verseNums.length === 1) {
        ...
        var res1v = mods.Formatter.formatLines(lines0, chords, null, -1, inlineSystemTexts, fretDiagrams);
    ...
    if (verse0Repeated.length > 0) {
        ...
        var res0MV = mods.Formatter.formatLines(verse0Repeated, chords, lastChordMV, repeatEndTickMV, null, fretDiagrams);
    ...
    for (var v5 = 1; v5 < verseNums.length; v5++) {
        ...
        var res5MV = mods.Formatter.formatLines(vLines5, chords, lastChordMV, repeatEndTickMV, null, fretDiagrams);
    ...
    if (verse0Coda.length > 0) {
        ...
        var resCMV = mods.Formatter.formatLines(verse0Coda, chords, lastChordMV, -1, null, fretDiagrams);
...
function processWithNavigation(data, mods) {
    ...
    var result2 = mods.Formatter.formatPerfLines(streamLines, introChords, homeChord, title, chords, syllables, data.systemTexts, data.fullRepeat, fretDiagrams);
