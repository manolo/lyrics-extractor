...
// mods: { ChordUtils } (for solfeo/anglo conversion)
function formatChordOnly(data, mods) {
    ...
    // Apply solfeo/anglo conversion
    if (data.solfeo !== false && mods && mods.ChordUtils) {
        mods.ChordUtils.convertChordsToSolfeo(chords);
    } else if (data.solfeo === false && mods && mods.ChordUtils) {
