...
function detectPhraseBreak(syl, nextSyl) {
    ...
    // Long rest after syllable: a full bar of 4/4 or more
    if (syl.restAfter && syl.restDurationQ >= 4) return true;

    // Word ends and a very significant vocal gap follows: two bars or more
    if (isWordEnd && syl.gapDurationQ >= 8) return true;

    // Very long note at word end: two bars or more
