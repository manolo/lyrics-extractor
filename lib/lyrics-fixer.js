...
function checkLyrics(lyricGroups) {
    ...
    for (var k = 0; k < keys.length; k++) {
        ...
        for (var i = 0; i < group.length; i++) {
            ...
            if (text.indexOf(';') >= 0 || text.match(/\.{2,}/) || text.match(/,,/)) {
                punctuation++;
                if (punctuationExamples.length < 4) punctuationExamples.push(text);
            }
    ...
    return {
        ...
        punctuationExamples: punctuationExamples
    };
}
