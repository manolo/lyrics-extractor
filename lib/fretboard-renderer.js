...
// opts: optional { accidentalFont, showTextOps } so chord names can use the drawn
// accidental glyphs instead of their plain spellings
function renderFretDiagram(diagram, x, y, escPdfString, opts) {
    ...
    if (opts && opts.showTextOps && opts.accidentalFont) {
        stream += opts.showTextOps(diagram.chordName, "F2", LABEL_SIZE, opts.accidentalFont);
    } else {
