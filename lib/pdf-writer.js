...
// Characters with no WinAnsi code, written with the plain spelling the base fonts
// can print. Prettified chord names carry the musical flat and sharp signs, and
// WinAnsiEncoding has neither, so without this they came out as question marks
// ("B♭" printed as "B?"). Each replacement is one character wide, which keeps the
// chord line aligned with the lyric line below it.
var PLAIN_SPELLING = {
    "♭": "b",  // musical flat
    "♯": "#",  // musical sharp
    "♮": "n",  // musical natural
